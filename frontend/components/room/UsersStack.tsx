...
function MemberRow({ m, speaking, expanded, onHover }: { m: Member; speaking?: boolean; expanded?: boolean; onHover: (id: string | null) => void }) {
...
export function UsersStack() {
  ...
  // sort: speaking first (stable), then others in original order
